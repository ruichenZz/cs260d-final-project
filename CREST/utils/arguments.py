...
def get_args():
    ...
    # General options
    parser.add_argument("--arch", default="resnet20", choices=['resnet20', 'resnet18', 'resnet50', 'transformer'],
        help="model architecture")
    parser.add_argument('--data_dir', default='~/data')
    parser.add_argument('--dataset', default='cifar10', choices=['cifar10', 'cifar100','tinyimagenet', 'Jigsaw'],
    ...
    parser.add_argument("--save_subset_dir")
